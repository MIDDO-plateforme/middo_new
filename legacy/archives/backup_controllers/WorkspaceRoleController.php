...
#[Route('/core_os/workspace/{workspaceId}/role')]
#[IsGranted('ROLE_USER')]
class WorkspaceRoleController extends AbstractController
{
    ...
    public function index(int $workspaceId): Response
    {
        ...
        return $this->render('core_os/workspace/role/index.html.twig', [
            'workspace' => $workspace,
            'roles' => $roles,
    ...
    public function invite(int $workspaceId, Request $request): Response
    {
        ...
        return $this->render('core_os/workspace/role/invite.html.twig', [
            'workspace' => $workspace,
            'form' => $form,
    ...
    public function edit(int $workspaceId, Request $request, WorkspaceRole $role): Response
    {
        ...
        return $this->render('core_os/workspace/role/edit.html.twig', [
            'workspace' => $workspace,
            'role' => $role,
            'form' => $form,
            'available_permissions' => self::PERMISSIONS,
