...
#[Route('/core_os/workspace/{workspaceId}/document')]
#[IsGranted('ROLE_USER')]
class WorkspaceDocumentController extends AbstractController
{
    ...
    public function index(int $workspaceId, WorkspaceDocumentRepository $repository): Response
    {
        ...
        return $this->render('core_os/workspace/document/index.html.twig', [
            'workspace' => $workspace,
            'documents' => $documents
        ]);
    }
    ...
    public function new(int $workspaceId, Request $request): Response
    {
        ...
        return $this->render('core_os/workspace/document/new.html.twig', [
            'workspace' => $workspace,
            'document' => $document,
            'form' => $form
        ]);
    ...
    public function show(int $workspaceId, WorkspaceDocument $document): Response
    {
        ...
        return $this->render('core_os/workspace/document/show.html.twig', [
    ...
    public function edit(int $workspaceId, Request $request, WorkspaceDocument $document): Response
    {
        ...
        return $this->render('core_os/workspace/document/edit.html.twig', [
            'workspace' => $document->getWorkspace(),
            'document' => $document,
            'form' => $form
        ]);
