...
class PaymentController extends AbstractController
{
    ...
    #[Route('/api/payment/domains/finance/escrow/lock', name: 'api_escrow_lock', methods: ['POST'])]
    ...
    #[Route('/api/payment/domains/finance/escrow/release', name: 'api_escrow_release', methods: ['POST'])]
