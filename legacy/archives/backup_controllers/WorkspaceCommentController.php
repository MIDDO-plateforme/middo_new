...
#[Route('/core_os/workspace/{workspaceId}/comment')]
#[IsGranted('ROLE_USER')]
class WorkspaceCommentController extends AbstractController
{
    ...
    public function list(int $workspaceId, string $entityType, int $entityId): Response
    {
        ...
        return $this->render('core_os/workspace/comment/list.html.twig', [
            'workspace' => $workspace,
            'comments' => $comments,
    ...
    public function edit(int $workspaceId, Request $request, WorkspaceComment $comment): Response
    {
        ...
        return $this->render('core_os/workspace/comment/edit.html.twig', [
            'workspace' => $workspace,
            'comment' => $comment,
            'form' => $form,
        ]);
