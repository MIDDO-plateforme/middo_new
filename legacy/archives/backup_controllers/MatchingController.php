...
class MatchingController extends AbstractController
{
    ...
    #[Route('/api/ia_engine/matching/find', name: 'api_matching_find', methods: ['POST'])]
    ...
    #[Route('/api/ia_engine/matching/mission/{id}', name: 'api_matching_mission_detail', methods: ['GET'])]
